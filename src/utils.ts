...
export function solve(symbols: readonly SymbolType[]): [SymbolType[], SymbolType[]] {
...
export const resolveSymbol = (symbol: SymbolType, index: number, symbols: readonly SymbolType[]): number =>
...
export const isWhite = (symbol: SymbolType): boolean => SYMBOLS[symbol].type === 'WHITE'

export const isPositive = (value: number): boolean => value > 0

export const sortDesc = (a: number, b: number): number => (a > b ? -1 : a < b ? 1 : 0)

export const is = (value: SymbolType) => (symbol: SymbolType): boolean => symbol === value

export const isnt = (value: SymbolType) => (symbol: SymbolType): boolean => symbol !== value
